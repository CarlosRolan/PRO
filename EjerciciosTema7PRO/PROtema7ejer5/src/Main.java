...
public class Main {
	...
	// Ejercicio 5: Añadir un alumno a la BD
	private static void addAlumnoBD(Statement s) throws SQLException {
		s.executeUpdate("INSERT INTO alumnos (DNI, NOMBRE, APELLIDO1, APELLIDO2, FECHA_NACIMIENTO, TELF) VALUES ('12341234A','BUGS','BUNNY','BUNNY','27/07/1940','12341234')");
	}
